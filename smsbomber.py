...
while 1:
    ...
    ║  {Fore.YELLOW}Sınırsız Sms Bomber Aracı{Fore.LIGHTCYAN_EX}                          ║
    ║  {Fore.GREEN}Kullanırken Çok Büyük Değerler Girmeniz Önerilmez.{Fore.LIGHTCYAN_EX} ║
    ║  {Fore.RED}Bu tool www.edevlet.org.tr yani No.2 Tarafından Publanmıştır.{Fore.LIGHTCYAN_EX}           ║
    ║  {Fore.CYAN}discord.gg/2Av866KDtY{Fore.LIGHTCYAN_EX}                                     ║
    ║  {Fore.LIGHTMAGENTA_EX}█████████████████████████████████████████████{Fore.LIGHTCYAN_EX}      ║
    ╚═════════════════════════════════════════════════════╝
    {Style.RESET_ALL}""")
